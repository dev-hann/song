import { z } from 'zod';
import type { SearchResultAudio as SearchResultAudioType, SearchResponse as SearchResponseType } from '@/types';
import { ThumbnailSchema } from './audio';
import { YouTubeVideoItemSchema, extractVideoFields, isAudioContent } from './youtube-common';
