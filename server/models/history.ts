...
export async function getRecentHistory(userId: string, limit = 100): Promise<HistoryItem[]> {
...
export async function addToHistory(userId: string, track: {
  videoId: string;
  title: string;
  channel: string;
  thumbnail: string;
