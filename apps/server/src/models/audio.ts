import { z } from 'zod';
import type { Audio as AudioType, ExtendedAudio as ExtendedAudioType } from '@song/types';
...
export type Audio = AudioType;
export type ExtendedAudio = ExtendedAudioType;
